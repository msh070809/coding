...
<script>
		...
		function getBoardList(page){	
			...
			var level_value = l_value;
			var category_value = c_value;
				...
				<div class="left-side">
					<div class="wrapper">
						...
						<nav class="slidemenu">
							...
							<input type="checkbox" name="slideItem" id="slide-item-3"
								value="3" class="slide-toggle" onclick="check_radio(this);" />
							<label for="slide-item-3"><p class="icon">3</p> <!--<span>Folio</span>--></label>

							<!-- Item 4 -->
							<input type="checkbox" name="slideItem" id="slide-item-4"
								value="4" class="slide-toggle" onclick="check_radio(this);" />
							<label for="slide-item-4"><p class="icon">4</p> <!--<span>Blog</span>--></label>
					...
					<nav class="menu" id="menu">
						<ul>
							...
							<li><a style="color: #b72b5c">자료구조</a>
								<ul style="display: block;">
							...
							<li onclick="check_list(this.id);" id="CA_0004"><a
								style="color: #b72b5c">정렬</a>
							<li onclick="check_list(this.id);" id="CA_0005"><a
								style="color: #b72b5c; font-size: 15px;">수학</a></li>
							<li><span class="opener"
								style="color: #b72b5c; font-size: 15px;">그래프</span>
								<ul>
									<li onclick="check_list(this.id);" id="CA_0006"><a>그래프</a></li>
									<li onclick="check_list(this.id);" id="CA_0007"><a>깊이
											우선 탐색</a></li>
									<li onclick="check_list(this.id);" id="CA_0008"><a>너비
											우선 탐색</a></li>
								</ul></li>
							<li><span class="opener"
								style="color: #b72b5c; font-size: 15px;">트리</span>
								<ul>
							...
							<li onclick="check_list(this.id);" id="CA_0011"><a
								style="color: #b72b5c">다이나믹 프로그래밍</a></li>
							<li onclick="check_list(this.id);" id="CA_0021"><a
								style="color: #b72b5c">그리디 알고리즘</a></li>
							<li onclick="check_list(this.id);" id="CA_0012"><a
								style="color: #b72b5c">재귀</a></li>
							<li onclick="check_list(this.id);" id="CA_0013"><span
								style="color: #b72b5c; font-size: 15px;">분할정복</span></li>

							<li><span style="color: #b72b5c; font-size: 15px;">최단경로</span>
								<ul>
									<li onclick="check_list(this.id);" id="CA_0014"><a>다익스트라</a></li>
									<li onclick="check_list(this.id);" id="CA_0015"><a>플로이드
											와샬</a></li>
									<li onclick="check_list(this.id);" id="CA_0016"><a>벨만포드</a></li>
								</ul></li>
							<li><span style="color: #b72b5c; font-size: 15px;">최소
									스패닝 트리</span>
								<ul>
							...
							<li onclick="check_list(this.id);" id="CA_0019"><a
								style="color: #b72b5c; font-size: 15px;">브루트포스</a></li>
							<li onclick="check_list(this.id);" id="CA_0020"><a
								style="color: #b72b5c; font-size: 15px;">백트래킹</a></li>
						</ul>
					</nav>
				</div>
									...
									<div id="problem_item_${status.count}" class="problem_item"
										...
										<div class="item_bottom">
											<div class="problem_submit" id="item_submit_${status.count}">
												제출한 사람 : ${problem.problem_submitnum}</div>
											<div class="problem_answer" id="item_success_${status.count}">
												맞은 사람 : ${problem.problem_successnum}</div>

											<div class="problem_check" id="item_check_${status.count}">
												<img
													src="<%=request.getContextPath()%>/resources/images/${successList[status.count-1] ? 'check.png' : 'notCheck.png'}"
