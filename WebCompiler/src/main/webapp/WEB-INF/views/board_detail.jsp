		...
		<div id="main">
			...
			<div class="inner">
				<section>
					...
					<div class="title_box">
						<span id="info_title">${board.board_title}</span> <span
							id="info_id">${board.user_id}</span>
					</div>
					<div></div>
					<div class="content">
						<p id="board_upload">
							<fmt:formatDate pattern="yyyy.MM.dd HH:mm:ss"
								value="${board.board_upload}" />
						</p>

						<div class="content_box">
							<p id="content_content">${board.board_content}<br>
						</div>

						<div class="info_box">
							<div class="comment_count">
								<img
									src="<%=request.getContextPath()%>/resources/images/comment.png"><span
									id="comment_count"></span>
							</div>
							<div class="board_info">
