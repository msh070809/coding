				...
				<section>
					...
					<form action="insert.do" method="post" onsubmit="return validate()">
						<div class="title_box" id="title_box">
									...
									<tbody>
										<tr>
											...
											<td class="table_value"><input type="text"
												name="problem_id" id="problem_id" style="width: 70px;" /> <input
												type="button" onclick="id_check(event)" class="id_check"
												value="중복확인"> <span class="alert_msg"
												id="id_check_alert" style="color: red;"> <img
													class="alert_img" id="alert_img"
										...
										<tr>
											...
											<td></td>
											<td class="alert"><span class="alert_msg" id="id_alert"
												style="color: red;"> <img class="alert_img"
													src="<%=request.getContextPath()%>/resources/images/alert.png"
													width="15" height="15" /> 필수 입력 항목입니다.
											</span></td>
											<td></td>
											<td></td>
											<td><span class="alert_msg" id="category_alert"
												style="color: red;"> <img class="alert_img"
													src="<%=request.getContextPath()%>/resources/images/alert.png"
													width="15" height="15" /> 필수 입력 항목입니다.
											</span></td>
											...
											<td></td>
											<td><span class="alert_msg" id="level_alert"
												style="color: red;"> <img class="alert_img"
													src="<%=request.getContextPath()%>/resources/images/alert.png"
													width="15" height="15" /> 필수 입력 항목입니다.
											</span></td>
										...
										<!-- 제목 -->
										<tr>
											<td class="table_key">제목</td>
											<td class="table_value"><input type="text"
												name="problem_title" id="problem_title" /></td>
										</tr>
										<!-- alert -->
										<tr>
											<td></td>
											<td class="alert"><span class="alert_msg"
												id="title_alert" style="color: red;"> <img
													class="alert_img"
													src="<%=request.getContextPath()%>/resources/images/alert.png"
													width="15" height="15" /> 필수 입력 항목입니다.
											</span></td>
										...
										<tr>
											...
											<td class="table_value"><input type="text"
												name="problem_time" id="problem_time" style="width: 50px;" /></td>
										</tr>

										<!-- alert -->
										<tr>
											<td></td>
											<td class="alert"><span class="alert_msg alert"
												id="time_alert" style="color: red;"> <img
													class="alert_img"
													src="<%=request.getContextPath()%>/resources/images/alert.png"
													width="15" height="15" /> 필수 입력 항목입니다.
											</span></td>
							...
							<br>
							<div style="margin: 0 3em;" class="intro-wrap">
								<span class="intros">문제 설명</span> <span class="alert_msg"
									id="content_alert" class="intros"> <img
									class="alert_img"
									src="<%=request.getContextPath()%>/resources/images/alert.png"
									width="15" height="15" /> 필수 입력 항목입니다.
								</span><br>
								<textarea name="problem_content" cols="100" rows="10"
									id="problem_content" style="resize: none;"></textarea>
								<br>
							</div>
						</div>
						<button type="submit" class="board_submit">등록</button>

						<input type="hidden" name="category_id" id="category_id" /> <input
							type="hidden" name="problem_level" id="problem_level" />
					</form>
				</section>
			</div>
		</div>
	...
	<script>
					...
					.ajax({
						...
						success : function(data) {
							...
							if (data.flag) {
								$("#id_check_alert")
										.html(
												"<img id='alert_img' style='vertical-align: middle; margin-right:0.2em;' width='15' height='15' src='/resources/images/alert.png'></img>이미 등록된 문제입니다.");
								$("#id_check_alert").css("color", "red");
								$("#id_check_alert").css("visibility",
										"visible");
								problem_id.value = "";
								check = false;
							}
							// 없는 문제
								...
								$("#id_check_alert")
										.html(
												"<img id='alert_img' style='vertical-align: middle; margin-right:0.2em;' width='15' height='15' src='/resources/images/check.png'></img>중복확인 완료");
								$("#id_check_alert").css("visibility",
										"visible");
		...
		function validate() {
			...
			if (!check) {
				$("#id_check_alert")
						.html(
								"<img id='alert_img' style='vertical-align: middle; margin-right:0.2em;' width='15' height='15' src='/resources/images/alert.png'></img>중복 확인 필요");
				$("#id_check_alert").css("color", "red");
