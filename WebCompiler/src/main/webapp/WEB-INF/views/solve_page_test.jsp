...
<link rel="stylesheet"
	href="<%=request.getContextPath()%>/resources/css/custom_solve_test_ui.css" />
<link rel="stylesheet"
...
<body>
	<div id="wrap">
		<header>
			<a class="back_btn" href="/problem"><img
			...
			<c:if test="${problem.problem_level == 1}">
				<div class="problem_level" style="background-color: #FFCC80">
					LEVEL ${problem.problem_level}</div>
			</c:if>
		...
		<div style="height: calc(100vh - 2.8em);">
			<aside>
				<div class="problem">
					<div class="problem_content" style="font-size: 15px">
						${problem.problem_content}</div>

					<div class="line"></div>

					<div>
						<h2 class="input_title" style="font-size: 20px">예제 입력</h2>

						<div class="testcase" style="font-size: 15px">
							${testcase.testcase_input}</div>
					...
					<div>
						...
						<h2 class="output_title" style="font-size: 20px">예제 출력</h2>
						<div class="testcase" style="font-size: 15px">
							${testcase.testcase_output}</div>
					</div>

				</div>
			</aside>
			<section class="code">
				<iframe id="iframe" onload="access()"
					src="<%=request.getContextPath()%>/resources/html/solve_editor.html"
					width="100%" height="100%"></iframe>
			</section>
			<section class="result">
				<div class="result_header">
					<div class="result_title">
						<span style="font-size: 15px;">실행 결과</span>
					</div>

					<div class="result_help" id="open">
						<a href="#" style="font-size: 15px;"> 토론하기 <img
					...
					<div class="modal hidden">
						...
						<div class="help_modal">
							...
							<div class="chat_textarea">
								<textarea id="chat_content" name="chat_content"
									onkeyup="enterkey();"></textarea>
								<div class="chat_send">
									<input id="chat_send" type="image"
