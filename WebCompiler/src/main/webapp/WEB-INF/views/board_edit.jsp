						...
						<div class="title_box" id="title_box">
							...
							<c:if test="${board.problem_id == 0}">
								...
								<div class="content_box code_box" id="code_box">
									<span id="id_label">문제번호</span><input type="text"
										id="problem_id" name="problem_id" value="${board.problem_id}" /><br />
							...
							<c:if test="${board.problem_id > 0 }">
								...
								<div class="content_box code_box" id="code_box"
									...
									<span>문제번호</span><input type="text" id="problem_id"
										name="problem_id" value="${board.problem_id}" style="margin-left:10px;"/><br /> <br>
