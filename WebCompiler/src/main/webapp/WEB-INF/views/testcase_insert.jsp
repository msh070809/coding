					...
					<form action="testcase.do" method="post"
						...
						<div class="title_box" id="title_box">
							<span class="alert_msg" id="id_alert" style="margin-left: 2em;">
								<img id="alert_img" class="alert_img"
								src="<%=request.getContextPath()%>/resources/images/alert.png"
								width="15" height="15" /> 필수 입력 항목입니다.
							</span><br> 번호 <input type="text" name="problem_id" id="problem_id" />
							<input type="button" onclick="id_check(event)" class="id_check"
								value="문제확인"> <span class="alert_msg"
								id="id_check_alert"> <img class="alert_img"
								src="<%=request.getContextPath()%>/resources/images/alert.png"
								width="15" height="15" /> 작성할 테스트케이스에 대한 문제를 확인해주세요.
							</span> <br>
							<br> 입력 <span class="alert_msg" id="input_alert"> <img
								class="alert_img"
								src="<%=request.getContextPath()%>/resources/images/alert.png"
								width="15" height="15" /> 필수 입력 항목입니다.
							</span><br>
							<textarea name="testcase_input" cols="100" rows="10"
								id="testcase_input"></textarea>
							<br> 출력 <span class="alert_msg" id="output_alert"> <img
								class="alert_img"
								src="<%=request.getContextPath()%>/resources/images/alert.png"
								width="15" height="15" /> 필수 입력 항목입니다.
							</span><br>
							<textarea name="testcase_output" cols="100" rows="10"
								id="testcase_output"></textarea>
							<br>
	...
	<script>
					...
					.ajax({
						...
						success : function(data) {
							...
							if (!data.flag) {
								$("#id_check_alert")
										.html(
												"<img id='alert_img' style='vertical-align: middle; margin-right:0.2em;' width='15' height='15' src='/resources/images/alert.png'></img>등록되지 않은 문제입니다.");
							...
							// 없는 문제
								...
								$("#id_check_alert")
										.html(
												"<img id='alert_img' style='vertical-align: middle; margin-right:0.2em;' width='15' height='15' src='/resources/images/check.png'></img>문제확인 완료");
								$("#id_check_alert").css("visibility",
										"visible");
		...
		function validate() {
			...
			if (!check) {
				$("#id_check_alert")
						.html(
								"<img id='alert_img' style='vertical-align: middle; margin-right:0.2em;' width='15' height='15' src='/resources/images/alert.png'></img>문제 확인 필요");
				$("#id_check_alert").css("color", "red");
