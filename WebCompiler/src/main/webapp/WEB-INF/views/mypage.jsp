		...
		<div id="main">
			...
			<div class="inner">
									...
									<tr class="open" id="tr${st_.index}">
										...
										<td><c:if test="${codeBoard.problem_level == 1}">
												<div id="code_board_problem_level" class="problem_level1">
													LEVEL ${codeBoard.problem_level}</div>
												...
												<div id="code_board_problem_level" class="problem_level3">
													LEVEL ${codeBoard.problem_level}</div>
											</c:if> <c:if test="${codeBoard.problem_level == 5}">
												<div id="code_board_problem_level" class="problem_level5">
													LEVEL ${codeBoard.problem_level}</div>
											</c:if> <c:if test="${codeBoard.problem_level == 4}">
												<div id="code_board_problem_level" class="problem_level4">
													LEVEL ${codeBoard.problem_level}</div>
											</c:if></td>
										<td id="code_board_code_date"><fmt:formatDate
												pattern="yyyy.MM.dd" value="${codeBoard.code_date}" /></td>
										<td id="code_board_code_success"><img
				...
				<footer class="footer_btns">
					<button class="header_signout" onClick="location.href='/logout.do'">로그아웃</button>
